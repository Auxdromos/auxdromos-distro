#!/bin/bash
# Script to set up IDP-specific parameters in AWS Systems Manager Parameter Store
# These parameters will be used by the Identity Provider (IDP) module
...
# Base path for IDP parameters
PARAM_PATH="/auxdromos/sit/idp"
...
echo "Setting up IDP module parameters in AWS Systems Manager Parameter Store"
...
create_parameter "EXTERNAL_PORT" "8081" "String" "$OVERWRITE"
create_parameter "INTERNAL_PORT" "8081" "String" "$OVERWRITE"
...
echo "----------------------------------------------------"
echo "IDP module parameter setup complete."
