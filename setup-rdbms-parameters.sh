#!/bin/bash
# Script to set up RDBMS-specific parameters in AWS Systems Manager Parameter Store
# These parameters will be used by the database module
...
# Base path for RDBMS parameters
PARAM_PATH="/auxdromos/sit/rdbms"
...
echo "Setting up RDBMS module parameters in AWS Systems Manager Parameter Store"
...
create_parameter "EXTERNAL_PORT" "8089" "String" "$OVERWRITE"
create_parameter "INTERNAL_PORT" "8089" "String" "$OVERWRITE"

echo "----------------------------------------------------"
echo "RDBMS module parameter setup complete."
