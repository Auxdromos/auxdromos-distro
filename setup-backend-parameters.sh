#!/bin/bash
# Script to set up backend-specific parameters in AWS Systems Manager Parameter Store
# These parameters will be used by the backend module
...
# Base path for backend parameters
PARAM_PATH="/auxdromos/sit/backend"
...
echo "Setting up backend module parameters in AWS Systems Manager Parameter Store"
...
create_parameter "EXTERNAL_PORT" "8083" "String" "$OVERWRITE"
create_parameter "INTERNAL_PORT" "8083" "String" "$OVERWRITE"

echo "----------------------------------------------------"
echo "Backend module parameter setup complete."
